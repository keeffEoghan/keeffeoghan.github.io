...
export default () => {
  ...
  Object.assign(demo.tracks.spawn, { radius: 0.475, speed: 0 });
  Object.assign(demo.tracks.blur, { radius: 4, limit: 0.4 });
  ...
  stages[1] = () => {
    setTimeout(() => {
        ...
        document.body.classList.remove('epok-folio--intro-run');
      },
      100);
